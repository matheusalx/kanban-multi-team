...
```bash
git remote add encore encore://kanban-multi-team-9fb2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/kanban-multi-team-9fb2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/kanban-multi-team-9fb2/settings/integrations/github)
